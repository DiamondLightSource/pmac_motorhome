...
"""
    ...
    plc.add_motor(2, htype=LIMIT, group=2, post=20000000,
                  enc_axes=[5, 6, 7, 8])
    plc.configure_group(2, pre=move_Y_to_safety,
...
"""
    ...
    plc.configure_group(3, pre=move_Bragg_to_safety,
    ...
    for group_num in (4, 5):
        plc.configure_group(group=group_num,
